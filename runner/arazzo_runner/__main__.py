...
async def main():
    parser = argparse.ArgumentParser(description="Arazzo Runner")
...
async def handle_show_env_mappings(runner: ArazzoRunner | None, args: argparse.Namespace):
    ...
    try:
        ...
        mappings = ArazzoRunner.generate_env_mappings(runner.arazzo_doc, runner.source_descriptions)
...
async def handle_execute_workflow(runner: ArazzoRunner | None, args: argparse.Namespace):
...
async def handle_list_workflows(runner: ArazzoRunner | None, args: argparse.Namespace):
...
async def handle_describe_workflow(runner: ArazzoRunner | None, args: argparse.Namespace):
...
async def handle_generate_example(runner: ArazzoRunner | None, args: argparse.Namespace):
    ...
    try:
        ...
        # Format the command example using the correct Arazzo Runner CLI format
