        ...
        "servers": [
            {
                ...
                "variables": {
                    "instance": {"default": "default", "description": "API instance name"}
                },
            }
        ],
        "paths": {
...
def test_execute_operation_with_server_vars_and_path_params(
    ...
    executor.execute_operation(
        ...
        inputs={"id": "12345"},
        runtime_params=RuntimeParams(servers={"MYAPI_RUNNER_SERVER_INSTANCE": "customerA"}),
    )
