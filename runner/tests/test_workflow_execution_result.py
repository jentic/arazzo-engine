...
from arazzo_runner.executor.output_extractor import OutputExtractor
from arazzo_runner.models import WorkflowExecutionResult, WorkflowExecutionStatus
...
class TestWorkflowExecutionResult(unittest.TestCase):
    ...
    def test_initialization(self):
        ...
        result = WorkflowExecutionResult(
            status=WorkflowExecutionStatus.WORKFLOW_COMPLETE, workflow_id="test_workflow"
        )
        ...
        step_outputs = {"step1": {"output1": "value1"}, "step2": {"output2": "value2"}}
...
class TestErrorContext(unittest.TestCase):
    ...
    def test_error_context_for_non_2xx_status(self):
        ...
        self.assertIn("runner_error_context", outputs)
        self.assertEqual(outputs["runner_error_context"]["http_code"], 400)
        self.assertEqual(outputs["runner_error_context"]["http_response"], response["body"])
        ...
        self.assertIn("runner_error_context", outputs)
        self.assertEqual(outputs["runner_error_context"]["http_code"], 500)
        self.assertEqual(outputs["runner_error_context"]["http_response"], response["body"])
    ...
    def test_no_error_context_for_2xx_status(self):
        ...
        self.assertNotIn("runner_error_context", outputs)
...
class TestIntegration(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.step_outputs = {
            ...
            "step2": {
                "output2": "value2",
                "runner_error_context": {"http_code": 404, "http_response": {"error": "Not Found"}},
            },
        }
    ...
    def test_error_context_in_workflow_result(self):
        ...
        self.assertIn("runner_error_context", result.step_outputs["step2"])
        error_context = result.step_outputs["step2"]["runner_error_context"]
